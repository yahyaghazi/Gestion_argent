...
Ce module définit la classe TransactionStock qui représente une transaction d'entrée, 
de sortie ou d'ajustement de stock.
"""
...
class TransactionStock:
    """
    Classe représentant une transaction de stock (entrée, sortie ou ajustement).
